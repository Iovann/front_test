import { ShelvesResponse, FormsResponse, BookResponse } from '../types/glose';

const API_ROOT = 'https://api.glose.com';

export async function fetchShelves(offset = 0, limit = 10): Promise<ShelvesResponse> {
...
export async function fetchShelfBooks(shelfId: string, offset = 0, limit = 10): Promise<FormsResponse> {
